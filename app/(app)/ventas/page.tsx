...
type OrderRow = { id: string; status: string; table_total: number; products_total: number; total: number; payment_method: string | null; created_at: string; pool_tables: { name: string } | { name: string }[] | null };
...
export default async function Page(){
 ...
 const orders=((data ?? []) as unknown as OrderRow[]).map((o) => ({ ...o, pool_tables: Array.isArray(o.pool_tables) ? (o.pool_tables[0] ?? null) : o.pool_tables }));
